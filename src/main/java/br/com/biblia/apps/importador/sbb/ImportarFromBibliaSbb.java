...
@Service
public class ImportarFromBibliaSbb {
	...
	@Autowired
	private GetVerseExtractedSbb getVerseExtracted;
	...
	public void executar() {
		...
		lst.add(new BibliaToImport("NOVA TRADUÇÃO NA LINGUAGEM DE HOJE (NTLH)", "NTLH", PORTUGUES));
		lst.forEach(b -> {
	...
	private void exec(String nomeVersao, String abreviacao, String idioma) {
		...
		for (SbbLivroEnum bkjLivroEnum : SbbLivroEnum.values()) {
	...
	private boolean areVersesCreated(SbbLivroEnum nviLivroEnum, Versao versao, Livro livro) {
